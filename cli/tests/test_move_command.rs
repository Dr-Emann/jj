...
fn test_move() {
    ...
    Working copy now at: kmkuslsw 1c03e3d3 (no description set) |f
    Parent commit      : znkkpsqq e9515f21 (no description set) |e
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: kmkuslsw c8d83075 (no description set) |f
    Parent commit      : znkkpsqq 2c50bfc5 (no description set) |e
    "###);
    ...
    Working copy now at: kmkuslsw 2b723b1d (no description set) |f
    Parent commit      : vruxwmqv 4293930d (no description set) |d e
    "###);
...
fn test_move_partial() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: vruxwmqv 71b69e43 (no description set) |d
    Parent commit      : qpvuntsm 3db0a2f5 (no description set) |a
    ...
    let stdout = test_env.jj_cmd_success(&repo_path, &["move", "-i", "--from", "c"]);
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: vruxwmqv 63f1a6e9 (no description set) |d
    Parent commit      : qpvuntsm 3db0a2f5 (no description set) |a
    Added 0 files, modified 1 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: vruxwmqv 17c2e663 (no description set) |d
    Parent commit      : qpvuntsm 3db0a2f5 (no description set) |a
    Added 0 files, modified 1 files, removed 0 files
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: vruxwmqv b670567d (no description set) |d
    Parent commit      : qpvuntsm 3db0a2f5 (no description set) |a
    "###);
}
