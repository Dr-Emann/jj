...
fn test_squash() {
    ...
    Parent commit      : kkmpptxz 6ca29c9d (no description set) |b c
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  b9280a9898cb
    ◉  6ca29c9d2e7c b c
    ...
    Working copy now at: mzvwutvl e87cf8eb (no description set) |c
    Parent commit      : qpvuntsm 893c93ae (no description set) |a b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  e87cf8ebc7e1 c
    ◉  893c93ae2a87 a b
    ...
    Parent commit      : nmzmmopx 80960125 (no description set) |e
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  959145c11426
    ◉    80960125bb96 e
...
fn test_squash_partial() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: mzvwutvl f03d5ce4 (no description set) |c
    Parent commit      : qpvuntsm c9f931cd (no description set) |a b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  f03d5ce4a973 c
    ◉  c9f931cd78af a b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: mzvwutvl e7a40106 (no description set) |c
    Parent commit      : kkmpptxz 05d95164 (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  e7a40106bee6 c
    ◉  05d951646873 b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: mzvwutvl a911fa1d (no description set) |c
    Parent commit      : kkmpptxz fb73ad17 (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  a911fa1d0627 c
    ◉  fb73ad17899f b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: mzvwutvl 5e297967 (no description set) |c
    Parent commit      : kkmpptxz ac258609 (no description set) |b
    "###);
    ...
    "###);
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: mzvwutvl 1c4e5596 (no description set) |c
    Parent commit      : kkmpptxz 16cc94b4 (no description set) |b
    "###);
}
