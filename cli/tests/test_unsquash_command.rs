...
fn test_unsquash() {
    ...
    Working copy now at: mzvwutvl 1b10d78f (no description set) |c
    Parent commit      : qpvuntsm 90aeefd0 (no description set) |a b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  1b10d78f6136 c
    ◉  90aeefd03044 a b
    ...
    Working copy now at: mzvwutvl 45b8b3dd (no description set) |c
    Parent commit      : kkmpptxz 9146bcc8 (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  45b8b3ddc25a c
    ◉  9146bcc8d996 b
    ...
    Parent commit      : mzvwutvl 90fe0a96 (no description set) |c e??
    Parent commit      : xznxytkn 5658521e (no description set) |d e??
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @    3217340cb761
    ├─╮
...
fn test_unsquash_partial() {
    ...
    insta::assert_snapshot!(stdout, @r###"
    Rebased 1 descendant commits
    Working copy now at: mzvwutvl 37c961d0 (no description set) |c
    Parent commit      : kkmpptxz 000af220 (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  37c961d0d1e2 c
    ◉  000af22057b9 b
    ...
    insta::assert_snapshot!(stdout, @r###"
    Working copy now at: mzvwutvl a8e8fded (no description set) |c
    Parent commit      : kkmpptxz 46cc0667 (no description set) |b
    "###);
    insta::assert_snapshot!(get_log_output(&test_env, &repo_path), @r###"
    @  a8e8fded1021 c
    ◉  46cc06672a99 b
