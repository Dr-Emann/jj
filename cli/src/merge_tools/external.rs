    ...
    if add_instructions {
        ...
        if diff_wc.right_working_copy_path() != output_wc_path {
            ...
            right_instructions_file
                .write_all(
                    b"\
The content of this pane should NOT be edited.

You are using experimental 3-pane diffedit. Some of the following
instructions might be written with a 2-pane diff in mind and thus
